...
2. После установки необходимо в терминале Linux либо в коммандной строке Windows прописать следующую команду: 
...
1. [IntelliJ IDEA Commynity](https://www.jetbrains.com/ru-ru/idea/download/#section=linux); 
2. Java 11 (скачивается в IntelliJ IDEA Commynity)
3. Firefox или Google Chrome
4. Docker (добавляется плагином в IntelliJ IDEA Commynity)

## Тестирование приложения

1. Открываем ранее полученный проект в IntelliJ IDEA Commynity;
...
1. Запускаеи приложение командой в терминале:
...
Для исправления данной ошибки рекумендуется перед запуском тестов ввести команду:
````chmod +x gradlew```` 
...
Примичание: возможно первый раз нужно будет сначала выполнить команду: 
